...
@Component({
  selector: 'app-resultados-carousel',
  standalone: false,
  templateUrl: './resultados-carousel.component.html',
  styleUrl: './resultados-carousel.component.css'
})
export class ResultadosCarouselComponent {
